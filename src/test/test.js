...
function getEBSTests() {
  ...
  return {"EBS GP2": [
    ...
    t.areClose(32000 * (0.065/730.0) + (60000-32000) * (0.0455/730.0, 0.000001),
     () => EC2_EBS_IO2_IOPS(60000, "us-east-1")),

     t.areClose(32000 * (0.065/730.0) + 32000 * (0.0455/730.0) + (70000-64000) * (0.03185/730.0, 0.000001),
     () => EC2_EBS_IO2_IOPS(70000, "us-east-1"))
