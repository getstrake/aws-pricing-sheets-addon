...
function RDS_STORAGE_AURORA_GB(settingsOrSize, sizeOrRegion, region) {
  if (typeof settingsOrSize === "string" || typeof settingsOrSize === "number") {
      return fetchApiRDSStorage({ storageType: "aurora", storageSize: settingsOrSize, region });
  } else {
...
function RDS_STORAGE_GP2_GB(settingsOrSize, sizeOrRegion, region) {
  if (typeof settingsOrSize === "string" || typeof settingsOrSize === "number") {
      return fetchApiRDSStorage({ storageType: "gp2", storageSize: settingsOrSize, region });
  } else {
...
function RDS_STORAGE_PIOPS_GB(settingsOrSize, sizeOrRegion, region) {
  if (typeof settingsOrSize === "string" || typeof settingsOrSize === "number") {
      return fetchApiRDSStorage({ storageType: "piops", storageSize: settingsOrSize, region });
  } else {
...
function RDS_STORAGE_MAGNETIC_GB(settingsOrSize, sizeOrRegion, region) {
  if (typeof settingsOrSize === "string" || typeof settingsOrSize === "number") {
      return fetchApiRDSStorage({ storageType: "magnetic", storageSize: settingsOrSize, region });
  } else {
